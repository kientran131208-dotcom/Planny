   ...
   return (
      <header className="mb-16 flex items-start justify-between px-4">
         <div className="space-y-4">
            ...
            <h1 className="text-7xl font-black text-[#031a6b] dark:text-white tracking-tighter leading-none">{t('focusTitle')}</h1>
         ...
         <div className="flex items-center gap-12 pt-8">
            <div className="text-right">
               ...
               <p className="text-lg font-black text-[#1151d3] dark:text-blue-400 flex items-center justify-end gap-2 leading-none uppercase">
                  <span className="w-1.5 h-1.5 rounded-full bg-green-500 shadow-[0_0_8px_#22c55e]"></span> {t('live')}
               </p>
            </div>
            <div className="w-20 h-20 rounded-[2.5rem] bg-white dark:bg-[#0f172a] border border-blue-50 dark:border-gray-800 flex items-center justify-center shadow-xl shadow-blue-50/50 dark:shadow-none">
               <span className="material-symbols-outlined text-[#1151d3] dark:text-blue-400 text-4xl font-black">timer</span>
            </div>
         </div>
      </header>
   );
