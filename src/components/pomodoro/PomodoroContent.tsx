      ...
      <div className="grid grid-cols-12 gap-10">
         ...
         <div className="col-span-12 lg:col-span-4 space-y-10">
            <div className="grid grid-cols-2 gap-6">
               <div className="p-10 bg-white dark:bg-[#0f172a] border border-gray-100 dark:border-gray-800 rounded-[3rem] shadow-[0_20px_50px_rgba(3,26,107,0.03)] dark:shadow-none text-center space-y-3 hover:scale-[1.02] transition-all">
                  <p className="text-[10px] font-black text-gray-300 dark:text-gray-600 uppercase tracking-widest leading-none">{t('focusMinutes')}</p>
                  <div className="flex items-baseline justify-center gap-1">
                     <h3 className="text-5xl font-black text-[#031a6b] dark:text-white tabular-nums tracking-tighter">{stats.totalMinutes}</h3>
                     <span className="text-[10px] font-black text-gray-300 dark:text-gray-600">{t('min')}</span>
                  </div>
                  <div className="h-1.5 w-12 bg-blue-100 dark:bg-blue-900/30 mx-auto rounded-full"></div>
               </div>
            ...
            <div className="bg-blue-50/50 dark:bg-blue-900/10 p-10 rounded-[3.5rem] border border-blue-50/50 dark:border-blue-900/20 space-y-6 relative group/goal overflow-hidden">
               {showGoalSettings && (
                  <div className="absolute inset-0 bg-white/95 dark:bg-[#0f172a]/95 backdrop-blur-md z-20 p-8 animate-in fade-in zoom-in-95 duration-300">
                     <div className="flex justify-between items-center mb-6">
                        <h5 className="text-[11px] font-black text-[#031a6b] dark:text-white uppercase tracking-[0.2em]">{t('goalSettings')}</h5>
                     ...
                     <div className="space-y-6">
                        <div className="space-y-2">
                           <div className="flex justify-between text-[10px] font-black text-gray-400 dark:text-gray-600 uppercase tracking-widest">
                              <span>{t('dailyGoal')}</span>
                              <span className="text-blue-600 dark:text-blue-400 font-black tabular-nums">{goals.day} {t('hour')}</span>
                           </div>
                           <input
                              type="range"
                              min={1}
                              ...
                              className="w-full h-1.5 bg-blue-100 dark:bg-gray-800 rounded-full appearance-none cursor-pointer accent-blue-600 dark:accent-blue-400"
                           />
                        </div>
                     </div>
                  </div>
               ...
               <div className="flex justify-between items-start relative z-10">
                  <div className="space-y-2">
                     <div className="flex items-center gap-2">
                        <h4 className="text-[11px] font-black text-[#031a6b] dark:text-white uppercase tracking-[0.2em]">{t('goalProgress')}</h4>
                     </div>
                     <div className="flex items-baseline gap-1">
                        <span className="text-xl font-black text-[#031a6b] dark:text-white tabular-nums tracking-tighter">
                           {formatGoalTime(stats.completedMinutes)}
                        </span>
                        <span className="text-xs font-black text-gray-300 dark:text-gray-600">/ {stats.currentGoalHours}h</span>
                     </div>
                  </div>
                  <button
                     onClick={() => setShowGoalSettings(true)}
                     className="w-8 h-8 rounded-xl bg-white dark:bg-[#1e293b] border border-gray-100 dark:border-gray-800 flex items-center justify-center text-gray-300 hover:text-blue-600 hover:shadow-lg hover:shadow-blue-100/50 dark:hover:shadow-none transition-all opacity-0 group-hover/goal:opacity-100"
                  >
               ...
               <div className="space-y-3 relative z-10">
                  <div className="relative h-4 bg-white dark:bg-[#1e293b] rounded-full overflow-hidden shadow-inner">
                     <div
            ...
            <div className="bg-white dark:bg-[#0f172a] rounded-[3.5rem] shadow-[0_30px_60px_rgba(3,26,107,0.04)] dark:shadow-none border border-gray-100 dark:border-gray-800 overflow-hidden flex flex-col min-h-[700px] animate-in fade-in slide-in-from-right-10 duration-700">
               <div className="p-10 border-b border-gray-50/50 dark:border-gray-800 bg-white dark:bg-[#0f172a]">
                  <div className="flex items-center gap-4 mb-10">
                     <div className="w-2.5 h-10 bg-blue-600 rounded-full shadow-[0_0_15px_rgba(37,99,235,0.4)]"></div>
                     <h3 className="text-2xl font-black text-[#031a6b] dark:text-white tracking-tight">{t('historyAndCalendar')}</h3>
                  </div>
               ...
               <div className="px-10 py-6 bg-gray-50/30 dark:bg-gray-800/20 border-b border-gray-50/50 dark:border-gray-800">
                  <div className="flex items-center justify-between">
                     <div className="flex gap-4">
                        <button
                           onClick={() => setCurrentRange('day')}
                           className="text-[9px] font-black uppercase tracking-widest px-3 py-1.5 rounded-xl transition-all shadow-sm text-blue-600 dark:text-blue-400 bg-white dark:bg-gray-800 ring-1 ring-blue-100/50 dark:ring-blue-900/30"
                        >
                     ...
                     <form action={handleClearHistory}>
                        <button
                           ...
                           className="w-10 h-10 rounded-2xl flex items-center justify-center text-gray-300 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all disabled:opacity-0"
               ...
               <div className="flex-1 overflow-y-auto p-10 space-y-8 custom-scrollbar relative">
                  {isLoading && (
                     <div className="absolute inset-0 bg-white/60 dark:bg-[#0f172a]/60 backdrop-blur-[1px] z-10 flex items-center justify-center animate-in fade-in duration-200">
                        <div className="flex flex-col items-center gap-3">
                           ...
                           <p className="text-[10px] font-black text-blue-600 dark:text-blue-400 uppercase tracking-widest">{t('loading')}</p>
                        </div>
                     </div>
                  )}
                  ...
                  {sessions.length === 0 ? (
                     <div className="h-full flex flex-col items-center justify-center opacity-30 space-y-6 py-12">
                        <div className="w-16 h-16 rounded-3xl bg-gray-50 dark:bg-gray-800 flex items-center justify-center">
                           <span className="material-symbols-outlined text-4xl text-gray-400 dark:text-gray-500">event_note</span>
                        </div>
                     ...
                     sessions.map((s, idx) => (
                        <div key={s.id || idx} className="relative pl-10 group animate-in slide-in-from-left-6 duration-500" style={{ animationDelay: `${idx * 50}ms` }}>
                           <div className="absolute left-[3px] top-0 bottom-0 w-px bg-gray-100/60 dark:bg-gray-800 group-last:bottom-auto group-last:h-4"></div>
                           <div className={`absolute left-[-2.5px] top-2 w-3 h-3 rounded-full ring-4 ring-white dark:ring-[#0f172a] shadow-sm ${(!s.mode || s.mode === 'FOCUS') ? 'bg-blue-600 shadow-blue-200 dark:shadow-none' : 'bg-green-500 shadow-green-200 dark:shadow-none'}`}></div>
                           ...
                           <div className="flex justify-between items-start">
                              <div className="space-y-2.5">
                                 <div className="flex items-center gap-3">
                                    ...
                                    <div className="h-px w-6 bg-gray-100 dark:bg-gray-800"></div>
                                    <span className={`text-[10px] font-black uppercase tracking-widest px-2 py-0.5 rounded-lg ${(!s.mode || s.mode === 'FOCUS') ? 'text-blue-600 bg-blue-50 dark:bg-blue-900/40' : 'text-green-600 bg-green-50 dark:bg-green-900/40'}`}>
                                 ...
                                 <div className="space-y-1">
                                    <div className="flex items-center gap-2 group/title">
                                       {editingId === s.id ? (
                                          <div className="flex items-center gap-2">
                                             <input
                                                autoFocus
                                                className="bg-gray-50 dark:bg-gray-800 px-2 py-1 rounded text-sm border border-gray-200 dark:border-gray-700 focus:outline-none focus:border-blue-500 dark:text-white"
                                                value={editValue}
                                          ...
                                          <>
                                             <h4 className="text-sm font-black text-[#031a6b] dark:text-white tracking-tight uppercase leading-none">
                                    ...
                                    {(s.subject) && (
                                       <div className="flex items-center gap-2">
                                          ...
                                          <span className="text-[9px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">{s.subject.name}</span>
                                       </div>
                                    )}
                                 </div>
                              </div>
                              <button
                                 ...
                                 className="opacity-0 group-hover:opacity-100 w-10 h-10 rounded-2xl flex items-center justify-center text-gray-300 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all transform hover:scale-110"
                              >
