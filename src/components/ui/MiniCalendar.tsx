...
export default function MiniCalendar({ onDateSelect, selectedDate }: MiniCalendarProps) {
  ...
  return (
    <div className="bg-white rounded-[2rem] p-6 shadow-[0_10px_30px_rgba(3,26,107,0.03)] selection:bg-blue-100">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-base font-black text-[#031a6b] capitalize flex items-center gap-2">
        ...
        <div className="flex gap-2">
          <button 
            ...
            className="w-8 h-8 rounded-full hover:bg-gray-50 flex items-center justify-center text-gray-400 hover:text-blue-600 transition-all border border-gray-100/50"
          >
        ...
        {[...Array(daysInMonth)].map((_, i) => {
          ...
          return (
            <button 
              ...
              className={`relative aspect-square flex items-center justify-center text-[12px] font-black rounded-xl transition-all group ${
                isSelected 
